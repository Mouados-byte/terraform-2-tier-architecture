resource "aws_instance" "My-web-instance1" {
  ...
  user_data                   = <<-EOF
        ...
        echo "<html><body><h1>This is a University project 1 </h1></body></html>" > /var/www/html/index.html
        EOF
}
...
resource "aws_instance" "My-web-instance2" {
  ...
  user_data                   = <<-EOF
        ...
        systemctl start httpd
        systemctl enable httpd
        echo "<html><body><h1>This is a University project 2 </h1></body></html>" > /var/www/html/index.html
        EOF
}